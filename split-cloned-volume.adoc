...
* クローンされたボリュームを分割するには、リンクを関連付ける必要があります。link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["既存のリンクを関連付ける方法、または新しいリンクを作成して関連付ける方法を学びます"^]。リンクが関連付けられたら、この操作に戻ります。
...
. 分割するクローンボリュームを含むボリュームのアクションメニューを選択します。
