...
summary: Workload Factory でボリュームの SMB または CIFS 共有を管理するには、作成、ユーザおよびグループアクセスの決定、削除が含まれます。 
---
= NetApp Workload Factory でボリュームの SMB/CIFS 共有を管理する
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
...
* SMB/CIFS共有を管理するには、リンクを関連付ける必要があります。link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["既存のリンクを関連付ける方法、または新しいリンクを作成して関連付ける方法を学びます"^]。リンクが関連付けられたら、この操作に戻ってください。
* アクセスを許可するユーザまたはグループと、許可する権限のレベルを決定します。




[[create-an-smbcifs-share-for-a-volume]]
...
. SMB共有を変更するボリュームのアクションメニューを選択します。
...
[[change-an-smbcifs-share-for-a-volume]]
...
[[delete-an-smbcifs-share-for-a-volume]]
