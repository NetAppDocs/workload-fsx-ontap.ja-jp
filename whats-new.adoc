...
ボリュームエクスプローラーは、NetApp Workload Factory のすべてのボリュームをシンプルに検索可能な形で表示します。どのボリュームがブロックワークロードまたはファイルワークロードに使用されているかをすばやく確認できます。各ボリュームの論理サイズ、物理的な使用容量、およびストレージ効率化機能（圧縮、重複排除、コンパクション）を使用しているかどうかを確認できます。名前、ステータス（利用可能／失敗）、レイテンシ、サイズ、使用容量、および保護機能でフィルタリングおよび並べ替えができます。
...
link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["NetApp Workload Factoryでファイルシステムにリンクを関連付ける方法を学びましょう"^]。
...
link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["LambdaリンクでFSx for ONTAPファイルシステムに接続"^]
...
link:https://docs.netapp.com/us-en/workload-fsx-ontap/manage-volume-capacity.html["ボリュームの自動拡張を有効にする"]
...
link:https://docs.netapp.com/us-en/workload-setup-admin/create-link.html["リンクの作成"^]
